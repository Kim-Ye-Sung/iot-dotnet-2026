...
### 웹을 사용하는 이유
- `설치가  필요`없음 - PC 프로그램은 설치파일, 모바일 앱은 앱스토어 설치 필요
...
- Boot Strap - 트위터에서 개발한 UI library
...
#### JS 목적
- HTML 요소에 접근해서 값을 변경하는 형태로 동적인 기능 추가하기 위한 것
- DOM에서 데이터를 가져와서 백엔드로 전송. DB 저장, 데이터 처리 기능
